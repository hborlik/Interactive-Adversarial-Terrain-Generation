...
#ifndef DIRTBOX_IMGUI_H_HEADER_GUARD
#define DIRTBOX_IMGUI_H_HEADER_GUARD

#include <bgfx/bgfx.h>
#include <dear-imgui/imgui.h>
#include <third_party/iconfontheaders/icons_kenney.h>
#include <third_party/iconfontheaders/icons_font_awesome.h>
...
namespace ImGui
{
	constexpr uint8_t IMGUI_FLAGS_NONE = UINT8_C(0x00);
	constexpr uint8_t IMGUI_FLAGS_ALPHA_BLEND = UINT8_C(0x01);
...
#endif // DIRTBOX_IMGUI_H_HEADER_GUARD
